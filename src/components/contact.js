                                ...
                                <form name="sentMessage" id="contactForm">
                                    ...
                                    <div className="control-group">
                                        <div className="form-group floating-label-form-group controls">
                                            ...
                                            <input className="form-control" id="phone" type="tel" placeholder="Phone Number" required
                                    ...
                                    <div className="control-group">
                                        <div className="form-group floating-label-form-group controls">
                                            <label>Message</label>
                                            <textarea className="form-control" id="message" rows="5" placeholder="Message" required
